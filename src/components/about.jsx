    ...
    return (
      <section className="about-section">
        ...
        <div className="about-content">
          ...
          <p>
            When I am not coding, I enjoy backpacking in different countries, going to raves and concerts in the city, long treks in nature, camping expeditions to the mountains, and anything adventurous. I am always eager to learn and stay up-to-date with the latest web development trends and technologies. 
          </p>
        </div>
      </section>
    );
